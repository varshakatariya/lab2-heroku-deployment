...
console.log("Inside kafkarpc.js");

function KafkaRPC(){
    console.log("Inside KafkaRPC()");
    self = this;
...
KafkaRPC.prototype.makeRequest = function(topic_name, content, callback){
    console.log("Inside Kafka RPC make request for sending to kafka using topic ",topic_name);
    self = this;
    ...
    self.setupResponseQueue(self.producer,topic_name,function(){
        console.log('in response inside kafka rpc ');
